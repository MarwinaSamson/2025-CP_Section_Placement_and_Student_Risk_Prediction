...
class StudentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'dialect_spoken': forms.Select(choices=[('', 'Select a dialect'), ('Chavacano', 'Chavacano'), ('Tagalog', 'Tagalog'), ('Bisaya', 'Bisaya'), ('Yakan', 'Yakan'), ('Tausug', 'Tausug'), ('Sama', 'Sama'), ('Other', 'Other')]),
            'ethnic_tribe': forms.Select(choices=[('', 'Select'), ('tagalog', 'Tagalog'), ('yakan', 'Yakan'), ('bisaya', 'Bisaya'), ('tausug', 'Tausug'), ('moros', 'Moros'), ('other', 'Other')]),
...
class StudentNonAcademicForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        cleaned_data['study_place'] = self._process_other_field(
            'study_place', 'study_place_other', is_multiple_choice=True)
        cleaned_data['live_with'] = self._process_other_field(
            'live_with', 'live_with_other', is_multiple_choice=True)
        cleaned_data['highest_education'] = self._process_other_field(
            'highest_education', 'highest_education_other')
        cleaned_data['marital_status'] = self._process_other_field(
            'marital_status', 'marital_status_other')
        cleaned_data['house_type'] = self._process_other_field(
            'house_type', 'house_type_other')
        cleaned_data['transport_mode'] = self._process_other_field(
            'transport_mode', 'transport_mode_other')
        cleaned_data['personality_traits'] = self._process_other_field(
            'personality_traits', 'personality_traits_other', is_multiple_choice=True)
