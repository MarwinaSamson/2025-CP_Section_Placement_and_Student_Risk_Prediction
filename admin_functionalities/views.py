...
# from .models import ActivityLog, Program
...
#     Returns JSON with section data including adviser, location, capacity.
#     """
#     try:
#         # ✅ Get the Program instance first
...
#         # ✅ Filter sections by Program instance (not string)
...
#                 'room': section.room,
#                 'location': f"Building {section.building} - Room {section.room}",  # ✅ Combined for display
...
#     The program parameter comes from the URL (e.g., /sections/add/STE)
#     """
#     try:
#         from admin_functionalities.models import Program
        
#         # Program-specific defaults for max_students
#         program_defaults = {
#             'STE': 30,
#             'SPFL': 30,
#             'SPTVL': 30,
...
#         # ✅ Get the Program instance BEFORE validating the form
#         program_name = program.upper()
#         try:
#             program_instance = Program.objects.get(name=program_name, is_active=True)
#         except Program.DoesNotExist:
#             return JsonResponse({
#                 'success': False, 
#                 'message': f'Program "{program_name}" does not exist in the database. Please contact the administrator to set up this program first.'
#             }, status=400)
...
#             # ✅ Assign the program instance (based on which tab the user is on)
#             section.program = program_instance
            
#             # Set max_students if not provided or invalid
...
#         import traceback
#         error_details = traceback.format_exc()
#         print(f"ERROR in add_section: {error_details}")  # For server logs
...
# # ============================================================================
# # ALSO UPDATE: update_section view (same principle)
# # ============================================================================
...
#     The program should NOT change (it's tied to the section's original program).
#     """
#     try:
#         section = get_object_or_404(Section, id=section_id)
        
#         # Keep the original program (don't allow changing it via form)
